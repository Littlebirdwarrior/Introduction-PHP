...
<body>
    ...
    <p> <b>Consignes : </b><br>
        Créer une classe Voiture possédant les propriétés suivantes : marque, modèle, nbPortes et vitesseActuelle ainsi
        que les méthodes demarrer( ), accelerer( ) et stopper( ) en plus des accesseurs (get) et mutateurs (set)
        traditionnels. La vitesse initiale de chaque véhicule
        ...
        vérifier la cohérence de la classe Voiture. Vous devez afficher les tests et les éléments
        suivants :<br>

        source <a
            href="https://coding-champ.com/tutorials/php/getters-and-setters">https://coding-champ.com/tutorials/php/getters-and-setters</a>
